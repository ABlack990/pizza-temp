...
const char weatherApiKey[] = "c2e83b3a7ba460b9e719d427b627d67f"; // Get a API key here: https://home.openweathermap.org/users/sign_up
const char server[] = "api.openweathermap.org";
const String resource = "/data/2.5/weather?zip=48823,US&units=imperial&appid=" + String(weatherApiKey); // Change zip code below for your region
const int  port = 443;
